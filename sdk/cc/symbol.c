...
static Sym *__sym_malloc(void)
{
    ...
    sym_pool = cc_malloc(SYM_POOL_NB * sizeof(Sym));
...
void *section_ptr_add(Section *sec, unsigned long size)
{
    ...
    if (new_offset > sec->data_allocated)
        section_realloc(sec, new_offset);
                       ...
                       int add_underscore)
{
    ...
    if (!sym->c)
    {
        ...
        else if (cc_state->leading_underscore && add_underscore)
        {
            buf1[0] = '_';
