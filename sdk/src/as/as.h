 ...
 * standard scanner is provided as part of aslib.c. The
...
/*
 * ----------------------------------------------------------------
 * Some lexical properties of the AS source language, included
...
#define OFMT_TEXT 1 /* Text file format */
     ...
     * the symbol, in AS's terms, and indicates whether it has
 ...
 */
extern const char as_version[];
extern const char as_date[];
extern const char as_compile_options[];
extern const char as_comment[];
extern const char as_signature[];
