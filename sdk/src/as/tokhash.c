...
#define UNUSED 16383
    ...
    static const struct tokendata tokendata[1732] = {
            ...
            {"seta",             TOKEN_INSN,     C_A,    I_SEcc},
            {"setae",            TOKEN_INSN,     C_AE,   I_SEcc},
            {"setb",             TOKEN_INSN,     C_B,    I_SEcc},
            {"setbe",            TOKEN_INSN,     C_BE,   I_SEcc},
            {"setc",             TOKEN_INSN,     C_C,    I_SEcc},
            {"sete",             TOKEN_INSN,     C_E,    I_SEcc},
            {"setg",             TOKEN_INSN,     C_G,    I_SEcc},
            {"setge",            TOKEN_INSN,     C_GE,   I_SEcc},
            {"setl",             TOKEN_INSN,     C_L,    I_SEcc},
            {"setle",            TOKEN_INSN,     C_LE,   I_SEcc},
            {"setna",            TOKEN_INSN,     C_NA,   I_SEcc},
            {"setnae",           TOKEN_INSN,     C_NAE,  I_SEcc},
            {"setnb",            TOKEN_INSN,     C_NB,   I_SEcc},
            {"setnbe",           TOKEN_INSN,     C_NBE,  I_SEcc},
            {"setnc",            TOKEN_INSN,     C_NC,   I_SEcc},
            {"setne",            TOKEN_INSN,     C_NE,   I_SEcc},
            {"setng",            TOKEN_INSN,     C_NG,   I_SEcc},
            {"setnge",           TOKEN_INSN,     C_NGE,  I_SEcc},
            {"setnl",            TOKEN_INSN,     C_NL,   I_SEcc},
            {"setnle",           TOKEN_INSN,     C_NLE,  I_SEcc},
            {"setno",            TOKEN_INSN,     C_NO,   I_SEcc},
            {"setnp",            TOKEN_INSN,     C_NP,   I_SEcc},
            {"setns",            TOKEN_INSN,     C_NS,   I_SEcc},
            {"setnz",            TOKEN_INSN,     C_NZ,   I_SEcc},
            {"seto",             TOKEN_INSN,     C_O,    I_SEcc},
            {"setp",             TOKEN_INSN,     C_P,    I_SEcc},
            {"setpe",            TOKEN_INSN,     C_PE,   I_SEcc},
            {"setpo",            TOKEN_INSN,     C_PO,   I_SEcc},
            {"sets",             TOKEN_INSN,     C_S,    I_SEcc},
            {"setz",             TOKEN_INSN,     C_Z,    I_SEcc},
