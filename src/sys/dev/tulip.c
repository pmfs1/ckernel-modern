...
static struct board board_tbl[] = {
        {"Digital",        "Digital DC21040 Tulip",                     BUSTYPE_PCI, PCI_UNITCODE(0x1011,
                                                                                                  0x0002), 0xffffffff, 0, 0,          0,    0,    DC21040},
        {"Digital",        "Digital DC21041 Tulip",                     BUSTYPE_PCI, PCI_UNITCODE(0x1011,
                                                                                                  0x0014), 0xffffffff, 0, 0,          0,    0,    DC21041},
        {"Digital",        "Digital DS21140A Tulip",                    BUSTYPE_PCI, PCI_UNITCODE(0x1011,
                                                                                                  0x0009), 0xffffffff, 0, 0,          0x20, 0xf0, DC21140},
        {"Digital",        "Digital DS21140 Tulip",                     BUSTYPE_PCI, PCI_UNITCODE(0x1011,
                                                                                                  0x0009), 0xffffffff, 0, 0,          0,    0,    DC21140},
        {"Digital",        "Digital DS21143-xD Tulip",                  BUSTYPE_PCI, PCI_UNITCODE(0x1011,
                                                                                                  0x0019), 0xffffffff, 0, 0,          0x40, 0xf0, DC21142 |
                                                                                                                                                  HAS_VLAN},
        {"Digital",        "Digital DS21143-xC Tulip",                  BUSTYPE_PCI, PCI_UNITCODE(0x1011,
                                                                                                  0x0019), 0xffffffff, 0, 0,          0x30, 0xf0, DC21142},
        {"Digital",        "Digital DS21142 Tulip",                     BUSTYPE_PCI, PCI_UNITCODE(0x1011,
                                                                                                  0x0019), 0xffffffff, 0, 0,          0,    0,    DC21142},
        {"Kingston",       "Kingston KNE110tx (PNIC)",                  BUSTYPE_PCI, PCI_UNITCODE(0x11AD,
                                                                                                  0x0002), 0xffffffff, PCI_UNITCODE(
                0x2646,
                0xf002),                                                                                                  0xffffffff, 0,    0,    LC82C168},
        {"Linksys",        "Linksys LNE100TX (82c168 PNIC)",            BUSTYPE_PCI, PCI_UNITCODE(0x11AD,
                                                                                                  0x0002), 0xffffffff, PCI_UNITCODE(
                0x11ad,
                0xffff),                                                                                                  0xffffffff, 17,   0xff, LC82C168},
        {"Linksys",        "Linksys LNE100TX (82c169 PNIC)",            BUSTYPE_PCI, PCI_UNITCODE(0x11AD,
                                                                                                  0x0002), 0xffffffff, PCI_UNITCODE(
                0x11ad,
                0xf003),                                                                                                  0xffffffff, 32,   0xff, LC82C168},
        {"Lite-On",        "Lite-On 82c168 PNIC",                       BUSTYPE_PCI, PCI_UNITCODE(0x11AD,
                                                                                                  0x0002), 0xffffffff, 0, 0,          0,    0,    LC82C168},
        {"Macronix",       "Macronix 98713 PMAC",                       BUSTYPE_PCI, PCI_UNITCODE(0x10d9,
                                                                                                  0x0512), 0xffffffff, 0, 0,          0,    0,    MX98713},
        {"Macronix",       "Macronix 98715 PMAC",                       BUSTYPE_PCI, PCI_UNITCODE(0x10d9,
                                                                                                  0x0531), 0xffffffff, 0, 0,          0,    0,    MX98715},
        {"Macronix",       "Macronix 98725 PMAC",                       BUSTYPE_PCI, PCI_UNITCODE(0x10d9,
                                                                                                  0x0531), 0xffffffff, 0, 0,          0,    0,    MX98725},
        {"ASIX",           "ASIX AX88141",                              BUSTYPE_PCI, PCI_UNITCODE(0x125B,
                                                                                                  0x1400), 0xffffffff, 0, 0,          0x10, 0xf0, AX88141},
        {"ASIX",           "ASIX AX88140",                              BUSTYPE_PCI, PCI_UNITCODE(0x125B,
                                                                                                  0x1400), 0xffffffff, 0, 0,          0,    0,    AX88140},
        {"Lite-On",        "Lite-On LC82C115 PNIC-II",                  BUSTYPE_PCI, PCI_UNITCODE(0x11AD,
                                                                                                  0xc115), 0xffffffff, 0, 0,          0,    0,    PNIC2},
        {"ADMtek",         "ADMtek AN981 Comet",                        BUSTYPE_PCI, PCI_UNITCODE(0x1317,
                                                                                                  0x0981), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Centaur-P",                          BUSTYPE_PCI, PCI_UNITCODE(0x1317,
                                                                                                  0x0985), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Centaur-C",                          BUSTYPE_PCI, PCI_UNITCODE(0x1317,
                                                                                                  0x1985), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"D-Link",         "D-Link DFE-680TXD v1.0 (ADMtek Centaur-C)", BUSTYPE_PCI, PCI_UNITCODE(0x1186,
                                                                                                  0x1541), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Centaur-C (Linksys v2)",             BUSTYPE_PCI, PCI_UNITCODE(0x13d1,
                                                                                                  0xab02), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Centaur-C (Linksys)",                BUSTYPE_PCI, PCI_UNITCODE(0x13d1,
                                                                                                  0xab03), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Centaur-C (Linksys)",                BUSTYPE_PCI, PCI_UNITCODE(0x13d1,
                                                                                                  0xab08), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Centaur-C (Linksys PCM200 v3)",      BUSTYPE_PCI, PCI_UNITCODE(0x1737,
                                                                                                  0xab09), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"STMicro",        "STMicro STE10/100 Comet",                   BUSTYPE_PCI, PCI_UNITCODE(0x104a,
                                                                                                  0x0981), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"STMicro",        "STMicro STE10/100A Comet",                  BUSTYPE_PCI, PCI_UNITCODE(0x104a,
                                                                                                  0x2774), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Comet-II",                           BUSTYPE_PCI, PCI_UNITCODE(0x1317,
                                                                                                  0x9511), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Comet-II (9513)",                    BUSTYPE_PCI, PCI_UNITCODE(0x1317,
                                                                                                  0x9513), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"SMC",            "SMC1255TX (ADMtek Comet)",                  BUSTYPE_PCI, PCI_UNITCODE(0x1113,
                                                                                                  0x1216), 0xffffffff, PCI_UNITCODE(
                0x10b8,
                0x1255),                                                                                                  0xffffffff, 0,    0,    COMET},
        {"Accton",         "Accton EN1217/EN2242 (ADMtek Comet)",       BUSTYPE_PCI, PCI_UNITCODE(0x1113,
                                                                                                  0x1216), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"SMC",            "SMC1255TX (ADMtek Comet-II)",               BUSTYPE_PCI, PCI_UNITCODE(0x10b8,
                                                                                                  0x1255), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"ADMtek",         "ADMtek Comet-II (model 1020)",              BUSTYPE_PCI, PCI_UNITCODE(0x111a,
                                                                                                  0x1020), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"Allied Telesyn", "Allied Telesyn A120 (ADMtek Comet)",        BUSTYPE_PCI, PCI_UNITCODE(0x1259,
                                                                                                  0xa120), 0xffffffff, 0, 0,          0,    0,    COMET},
        {"Compex",         "Compex RL100-TX",                           BUSTYPE_PCI, PCI_UNITCODE(0x11F6,
                                                                                                  0x9881), 0xffffffff, 0, 0,          0,    0,    COMPEX9881},
        {"Intel",          "Intel 21145 Tulip",                         BUSTYPE_PCI, PCI_UNITCODE(0x8086,
                                                                                                  0x0039), 0xffffffff, 0, 0,          0,    0,    I21145},
        {"Xircom",         "Xircom Tulip clone",                        BUSTYPE_PCI, PCI_UNITCODE(0x115d,
                                                                                                  0x0003), 0xffffffff, 0, 0,          0,    0,    XIRCOM},
        {"Davicom",        "Davicom DM9102",                            BUSTYPE_PCI, PCI_UNITCODE(0x1282,
                                                                                                  0x9102), 0xffffffff, 0, 0,          0,    0,    DC21140},
        {"Davicom",        "Davicom DM9100",                            BUSTYPE_PCI, PCI_UNITCODE(0x1282,
                                                                                                  0x9100), 0xffffffff, 0, 0,          0,    0,    DC21140},
        {"Macronix",       "Macronix mxic-98715 (EN1217)",              BUSTYPE_PCI, PCI_UNITCODE(0x1113,
                                                                                                  0x1217), 0xffffffff, 0, 0,          0,    0,    MX98715},
        {"Conexant",       "Conexant LANfinity",                        BUSTYPE_PCI, PCI_UNITCODE(0x14f1,
                                                                                                  0x1803), 0xffffffff, 0, 0,          0,    0,    CONEXANT},
        {"3Com",           "3Com 3cSOHO100B-TX (ADMtek Centaur)",       BUSTYPE_PCI, PCI_UNITCODE(0x10b7,
                                                                                                  0x9300), 0xffffffff, 0, 0,          0,    0,    COMET},
        {NULL,},
};
...
static struct tulip_chip_table tulip_tbl[] = {
        ...
        {"Digital DS21143 Tulip",   128, 0x0801fbff, HAS_MII | HAS_MEDIA_TABLE | ALWAYS_CHECK_MII | HAS_PWRDWN |
                                                     HAS_NWAY | HAS_INTR_MITIGATION,            nway_timer},
        ...
        {"ASIX AX88140",            128, 0x0001fbff, HAS_MII | HAS_MEDIA_TABLE | CSR12_IN_SROM | MC_HASH_ONLY |
                                                     IS_ASIX,                                   tulip_timer},
        {"ASIX AX88141",            128, 0x0001fbff, HAS_MII | HAS_MEDIA_TABLE | CSR12_IN_SROM | MC_HASH_ONLY |
                                                     IS_ASIX,                                   tulip_timer},
        ...
        {"Intel DS21145 Tulip",     128, 0x0801fbff, HAS_MII | HAS_MEDIA_TABLE | ALWAYS_CHECK_MII | HAS_PWRDWN |
                                                     HAS_NWAY,                                  nway_timer},
        {"Xircom tulip work-alike", 128, 0x0801fbff, HAS_MII | HAS_MEDIA_TABLE | ALWAYS_CHECK_MII | HAS_PWRDWN |
                                                     HAS_NWAY,                                  nway_timer},
...
static void start_link(struct dev *dev) {
    ...
    if ((tp->flags & ALWAYS_CHECK_MII) || (tp->mtable && tp->mtable->has_mii) ||
        ...
        for (phyn = 1; phyn <= 32 && phy_idx < sizeof(tp->phys); phyn++) {
            ...
            if ((mii_status & 0x8301) == 0x8001 || ((mii_status & 0x8000) == 0 && (mii_status & 0x7800) != 0)) {
                ...
                tp->phys[phy_idx++] = phy;
                kprintf(KERN_INFO
                "%s:  MII transceiver #%d config %4.4x status %4.4x advertising %4.4x.\n", dev->name, phy, mii_reg0, mii_status, mii_advert);

                // Fixup for DLink with miswired PHY
                if (mii_advert != to_advert) {
                    kprintf(KERN_DEBUG
                    "%s:  Advertising %4.4x on PHY %d, previously advertising %4.4x.\n", dev->name, to_advert, phy, mii_advert);
                    mdio_write(dev, phy, 4, to_advert);
                }

                // Enable autonegotiation: some boards default to off
                mdio_write(dev, phy, 0, (mii_reg0 & ~0x3000) | (tp->full_duplex ? 0x0100 : 0x0000) |
                                        ((media_cap[tp->default_port] & MediaIs100) ? 0x2000 : 0x1000));
            }
        }
    ...
    if (i >= 8) {
        ...
        for (i = 0; eeprom_fixups[i].name; i++) {
            if (tp->hwaddr.addr[0] == eeprom_fixups[i].addr0 &&
                ...
                if (tp->hwaddr.addr[2] == 0xE8 && ee_data[0x1a] == 0x55)
    ...
    if (mtable) {
        ...
        switch (mleaf->type) {
            ...
            case 4: {
                ...
                kprintf(KERN_DEBUG
                "%s: 21143 non-MII %s transceiver control %4.4x/%4.4x.\n", dev->name, medianame[tp->if_port], setup[0], setup[1]);
                if (p[0] & 0x40) {
        ...
        kprintf(KERN_DEBUG
        "%s: 21041 using media %s, CSR12 is %4.4x.\n", dev->name, medianame[port == 3 ? 12 : port], readl(
                ioaddr + CSR12));
        ...
        kprintf(KERN_DEBUG
        "%s: No media description table, assuming %s transceiver, CSR12 %2.2x.\n", dev->name, medianame[tp->if_port], readl(
                ioaddr + CSR12));
    }
    ...
    switch (tp->chip_id) {
        ...
        case DC21142:
            if (tp->mii_cnt) {
                select_media(dev, 1);
                kprintf(KERN_INFO
                "%s: Using MII transceiver %d, status %4.4x.\n", dev->name, tp->phys[0], mdio_read(dev, tp->phys[0],
                                                                                                   1));
                writel(0x82020000, ioaddr + CSR6);
                tp->csr6 = 0x820E0000;
                tp->if_port = 11;
...
static int check_duplex(struct dev *dev) {
    ...
    kprintf(KERN_INFO
    "%s: MII link partner %4.4x, negotiated %4.4x.\n", dev->name, mii_reg5, negotiated);
    ...
    if ((mii_reg5 & 0x4000) == 0 && ((mii_reg1 = mdio_read(dev, tp->phys[0], 1)) & 0x0004) == 0) {
        ...
        if ((new_reg1 & 0x0004) == 0) {
            kprintf(KERN_INFO
            "%s: No link beat on the MII interface, status %4.4x.\n", dev->name, new_reg1);
            return -1;
        }
    }
    ...
    if (tp->full_duplex != duplex) {
        ...
        kprintf(KERN_INFO
        "%s: Setting %s-duplex based on MII #%d link partner capability of %4.4x.\n",
    ...
    switch (tp->chip_id) {
        ...
        default: {
            ...
            if (tp->mtable == NULL) {
                ...
                next_tick = 60 * HZ;
                kprintf(KERN_DEBUG
                "%s: network media monitor CSR6 %8.8x CSR12 0x%2.2x.\n", dev->name, readl(ioaddr + CSR6), csr12 & 0xff);
                break;
            }
            ...
            switch (mleaf->type) {
                ...
                case 4: {
                    ...
                    if (p[offset + 1] & 0x80) {
                        kprintf(KERN_DEBUG
                        "%s: Transceiver monitor tick CSR12=%#2.2x, no media sense.\n", dev->name, csr12);
                        if (mleaf->type == 4) {
                    ...
                    kprintf(KERN_DEBUG
                    "%s: No link beat on media %s, trying transceiver type %s.\n",
                            dev->name, medianame[mleaf->media & MEDIA_MASK],
...
static void nway_timer(void *data) {
    ...
    kprintf(KERN_INFO
    "%s: N-Way autonegotiation status %8.8x, %s.\n", dev->name, csr12, medianame[tp->if_port]);
    ...
    if (media_cap[tp->if_port] & MediaIsMII) {
        ...
        if (csr12 & 2) {
            ...
            kprintf(KERN_INFO
            "%s: No 21143 100baseTx link beat, %8.8x, trying NWay.\n", dev->name, csr12);
            nway_start(dev);
            next_tick = 3 * HZ;
        }
...
static void nway_start(struct dev *dev) {
    ...
    kprintf(KERN_DEBUG
    "%s: Restarting internal NWay autonegotiation, %8.8x.\n", dev->name, csr14);
...
static void nway_lnk_change(struct dev *dev, int csr5) {
    ...
    if (tp->chip_id == PNIC2) {
        kprintf(KERN_INFO
        "%s: PNIC-2 link status changed, CSR5/12/14 %8.8x %8.8x, %8.8x.\n", dev->name, csr12, csr5, readl(
                ioaddr + CSR14));
        tp->if_port = 5;
        tp->lpar = csr12 >> 16;
        tp->nwayset = 1;
    ...
    kprintf(KERN_INFO
    "%s: 21143 link status interrupt %8.8x, CSR5 %x, %8.8x.\n", dev->name, csr12, csr5, readl(ioaddr + CSR14));
    ...
    if (tp->nway && !tp->nwayset && (csr12 & 0x7000) == 0x5000) {
        ...
        if (tp->nwayset) {
            kprintf(KERN_INFO
            "%s: Switching to %s based on link negotiation %4.4x & %4.4x = %4.4x.\n", dev->name, medianame[tp->if_port], tp->sym_advertise, tp->lpar, negotiated);
        } else {
            kprintf(KERN_INFO
            "%s: Autonegotiation failed, using %s, link beat status %4.4x.\n", dev->name, medianame[tp->if_port], csr12);
        }
...
static void pnic_timer(void *data) {
    ...
    if (media_cap[tp->if_port] & MediaIsMII) {
        ...
        if (phy_reg & 0x04000000) {
            ...
            // 100baseTx link beat
            kprintf(KERN_DEBUG
            "%s: %s link beat failed, CSR12 %4.4x, CSR5 %8.8x, PHY %3.3x.\n",
                    dev->name, medianame[tp->if_port], csr12,
            ...
            if (tp->csr6 != new_csr6) {
                ...
                tp->trans_start = get_ticks();
                kprintf(KERN_INFO
                "%s: Changing PNIC configuration to %s %s-duplex, CSR6 %8.8x.\n",
                        dev->name, medianame[tp->if_port],
...
static void comet_timer(void *data) {
    ...
    kprintf(KERN_DEBUG
    "%s: Comet link status %4.4x partner capability %4.4x.\n",
...
static void tulip_tx_timeout(struct dev *dev) {
    ...
    if (media_cap[tp->if_port] & MediaIsMII) {
        ...
        kprintf(KERN_WARNING
        "%s: Transmit timeout using MII device, status %4.4x.\n", dev->name, mii_bmsr);
        if (!(mii_bmsr & 0x0004)) {
        ...
        switch (tp->chip_id) {
            ...
            case DC21041: {
                ...
                kprintf(KERN_WARNING
                "%s: 21041 transmit timed out, status %8.8x, CSR12 %8.8x, CSR13 %8.8x, CSR14 %8.8x, resetting...\n",
            ...
            case DC21142:
                if (tp->nwayset) {
                    kprintf(KERN_WARNING
                    "%s: Transmit timed out, status %8.8x, SIA %8.8x %8.8x %8.8x %8.8x, restarting NWay .\n",
            ...
            case COMPEX9881:
                kprintf(KERN_WARNING
                "%s: %s transmit timed out, status %8.8x, SIA %8.8x %8.8x %8.8x %8.8x, resetting...\n",
            ...
            case PNIC2:
                kprintf(KERN_WARNING
                "%s: PNIC2 transmit timed out, status %8.8x, CSR6/7 %8.8x / %8.8x CSR12 %8.8x, resetting...\n",
...
static int tulip_transmit(struct dev *dev, struct pbuf *p) {
    ...
    if (wait_for_object(&tp->tx_sem, TX_TIMEOUT) < 0) {
        kprintf(KERN_WARNING
        "%s: transmit timeout, drop packet\n", dev->name);
        tp->stats.tx_dropped++;
        return -ETIMEOUT;
    }
...
static int tulip_rx(struct dev *dev) {
        ...
        if ((status & 0x38008300) != 0x0300) {
            if ((status & 0x38000300) != 0x0300) {
                ...
                if ((status & 0xffff) != 0x7fff) {
                    kprintf(KERN_WARNING
                    "%s: Oversized Ethernet frame spanned multiple buffers, status %8.8x!\n", dev->name, status);
    ...
    for (; tp->cur_rx - tp->dirty_rx > 0; tp->dirty_rx++) {
        ...
        if (tp->rx_pbuf[entry] == NULL) {
            ...
            if (p == NULL) {
                if (tp->cur_rx - tp->dirty_rx == RX_RING_SIZE) kprintf(KERN_ERR
                "%s: No kernel memory to allocate receive buffers.\n", dev->name);
                break;
            }
...
static void tulip_dpc(void *arg) {
    ...
    while (1) {
        ...
        if (csr5 & AbnormalIntr) {
            ...
            if (csr5 & PCIBusError) kprintf(KERN_ERR
            "%s: PCI Fatal Bus Error, %8.8x.\n", dev->name, csr5);
            if (csr5 & TxFIFOUnderflow) {
                ...
                kprintf(KERN_WARNING
                "%s: Tx threshold increased, new CSR6 %x.\n", dev->name, tp->csr6);
            }

            if (csr5 & TxDied) {
                // This is normal when changing Tx modes
                kprintf(KERN_WARNING
                "%s: The transmitter stopped. CSR5 is %x, CSR6 %x, new CSR6 %x.\n",
        ...
        if (--work_budget < 0) {
            kprintf(KERN_WARNING
            "%s: Too much work during an interrupt, csr5=0x%8.8x.\n", dev->name, csr5);
...
static struct dev *tulip_probe(struct unit *pdev, struct board *board, int ioaddr, char *opts) {
    ...
    if (readl(ioaddr + CSR5) == 0xffffffff) {
        kprintf(KERN_ERR
        "The Tulip chip at %#lx is not functioning.\n", ioaddr);
        return 0;
    }
    ...
    kprintf(KERN_INFO
    "%s: %s rev %d at %#3lx,", dev->name, board->productname, chip_rev, ioaddr);
