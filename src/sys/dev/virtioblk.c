...
struct virtio_blk_config {
    unsigned __int64
    capacity;         // The capacity (in 512-byte sectors)
...
static int install_virtioblk(struct unit *unit) {
    ...
    rc = virtio_device_init(&vblk->vd, unit,
                            VIRTIO_BLK_F_SEG_MAX | VIRTIO_BLK_F_SIZE_MAX | VIRTIO_BLK_F_GEOMETRY | VIRTIO_BLK_F_RO |
