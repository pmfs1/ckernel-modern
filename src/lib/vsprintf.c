...
int vsprintf(char *buf, const char *fmt, va_list args) {
    ...
    for (str = buf; *fmt; fmt++) {
        ...
        switch (*fmt) {
            ...
            case 'a':
                if (qualifier == 'l') {
                    str = eaddr(str, va_arg(args,
                    unsigned char *), field_width, precision, flags);
                } else {
                    str = iaddr(str, va_arg(args,
                    unsigned char *), field_width, precision, flags);
                }
                continue;
            ...
            case 'f':
            case 'g':
                str = flt(str, va_arg(args,
                double), field_width, precision, *fmt, flags | SIGN);
                continue;
