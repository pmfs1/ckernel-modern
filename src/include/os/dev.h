...
krnlapi int dev_close(dev_t
devno);

krnlapi int dev_ioctl(dev_t
devno,
int cmd,
void *args, size_t
size);
krnlapi int dev_read(dev_t
devno,
void *buffer, size_t
count,
blkno_t blkno,
...
krnlapi int dev_detach(dev_t
devno);
krnlapi int dev_transmit(dev_t
devno,
struct pbuf *p
);
krnlapi int dev_receive(dev_t
devno,
struct pbuf *p
);

krnlapi int dev_setevt(dev_t
devno,
int events
);
krnlapi int dev_clrevt(dev_t
devno,
int events
);
